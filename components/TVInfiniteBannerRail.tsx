...
const TV_BANNERS = [
  { id: 1, src: '/images/tv1.jpg', alt: 'TV Banner 1', href: '/marketplace?category=Electronics%20and%20Technology' },
  { id: 2, src: '/images/tv2.jpg', alt: 'TV Banner 2', href: '/marketplace?category=Electronics%20and%20Technology' },
  { id: 3, src: '/images/tv3.jpg', alt: 'TV Banner 3', href: '/marketplace?category=Electronics%20and%20Technology' },
]

export default function TVInfiniteBannerRail() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setActiveIndex((prev) => {
        const next = (prev + 1) % TV_BANNERS.length
        scrollToIndex(next)
        return next
      })
    }, 2000)
  ...
  return (
    <section className="relative py-2 bg-slate-50" aria-label="TV promotional banners">
