...
export type AuditAction = 
  | 'VENDOR_APPROVED' | 'VENDOR_REJECTED' | 'USER_SUSPENDED' | 'USER_REACTIVATED' | 'ACCOUNT_DEACTIVATED' | 'ACCOUNT_DELETE_REQUESTED' | 'LOGOUT_ALL_DEVICES' | 'ORDER_CANCELLED' | 'ORDER_REFUNDED' | 'PRODUCT_REMOVED' | 'SUPPORT_TICKET_UPDATED' | 'KYC_APPROVED' | 'KYC_REJECTED' | 'KYC_SUBMITTED'
