...
const BAG_BANNERS = [
  { id: 1, src: '/images/bag1.jpg', alt: 'Ladies Bag Banner 1', href: '/marketplace?category=Ladies%20Bags' },
  { id: 2, src: '/images/bag2.jpg', alt: 'Ladies Bag Banner 2', href: '/marketplace?category=Ladies%20Bags' },
  { id: 3, src: '/images/bag3.jpg', alt: 'Ladies Bag Banner 3', href: '/marketplace?category=Ladies%20Bags' },
]

export default function BagInfiniteBannerRail() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setActiveIndex((prev) => {
        const next = (prev + 1) % BAG_BANNERS.length
        scrollToIndex(next)
        return next
      })
    }, 2000)
  ...
  return (
    <section className="relative py-2 bg-slate-50" aria-label="Ladies Bag promotional banners">
