...
const faqData: FAQ[] = [
  ...
  },
  {
    ...
    answer: 'Vendors receive 100% of the product price minus platform commission (if applicable) and payment processing fees. Payouts are processed monthly via bank transfer.'
  },
  // Payments & Refunds
  {
    id: '7',
  ...
  },
  {
    ...
    answer: 'Payment declines can occur due to insufficient funds, incorrect card details, or bank security flags. Please verify your information or contact your bank. You can also try an alternative payment method.'
  },
  // Orders & Delivery
  {
    id: '10',
  ...
  },
  {
    ...
    answer: 'Orders can only be modified or cancelled within 1 hour of placement if they haven\'t entered processing. Contact support immediately for assistance.'
  },
  {
    id: '12',
    category: 'Orders & Delivery',
    question: 'What if my order arrives damaged?',
    answer: 'Take photos of the damaged items and contact the seller immediately through your order page. If the seller doesn\'t respond within 48 hours, our support team will intervene.'
  },
  // Vendor Verification
  {
    id: '13',
  ...
  // Featured Vendors
  {
    ...
    answer: 'Featured vendor status is awarded to top-performing stores with excellent customer ratings, fast shipping, and high-quality products. Admin may also feature vendors manually based on merit.'
  },
  {
    id: '16',
    category: 'Featured Vendors',
    question: 'What are the benefits of being featured?',
    answer: 'Featured vendors receive premium placement on the marketplace, increased visibility, a special badge on their store, and access to promotional opportunities.'
  },
  // Account & Security
  {
    id: '17',
    ...
    answer: 'Click "Forgot Password" on the login page. Enter your email address and follow the reset link sent to your inbox. The link expires in 1 hour.'
  },
  {
    id: '18',
    category: 'Account & Security',
    question: 'How do I update my profile information?',
    answer: 'Log in and go to Dashboard > Settings. You can update your name, phone, address, and profile picture there.'
  },
  {
    id: '19',
    category: 'Account & Security',
    question: 'How do I delete my account?',
    answer: 'Contact our support team to request account deletion. Please note that account deletion is permanent and will remove all your data, order history, and reviews.'
  },
  // Technical Issues
  {
    id: '20',
    ...
    answer: 'Try clearing your browser cache, disabling browser extensions, or using a different browser. If the issue persists, try accessing the site from a different device or contact support.'
  },
  {
    id: '21',
    category: 'Technical Issues',
    question: 'I can\'t upload product images. Help!',
    answer: 'Ensure your images are in JPG, PNG, or WebP format and under 10MB. If uploads still fail, check your internet connection or try a different browser. Contact support if the problem continues.'
  },
  {
    id: '22',
    category: 'Technical Issues',
    question: 'I\'m not receiving email notifications.',
    answer: 'Check your spam folder first. Ensure you\'ve added our email address to your contacts. Verify your email address in account settings. If issues persist, contact support to update your email.'
  },
]
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28">
          <div className="text-center text-white">
            ...
            <p className="text-lg sm:text-xl text-slate-300 max-w-2xl mx-auto">
              Find answers to common questions about Dhream Market. Browse by category or search for specific topics.
            </p>
          </div>
        </div>
      </div>
...
<button className="flex-shrink-0 w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 flex items-center justify-center transition-colors">
        ...
        <Card variant="elevated" className="mt-12 bg-gradient-to-br from-royal-blue to-purple-600 text-white">
          <CardContent className="p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button variant="secondary" size="lg" onClick={() => window.location.href = '/help'}>Contact Support</Button>
              <Button variant="outline" size="lg" onClick={() => window.location.href = '/contact'} className="!border-white !text-white hover:!bg-white/10">Send Feedback</Button>
            </div>
          </CardContent>
        </Card>
      </div>
