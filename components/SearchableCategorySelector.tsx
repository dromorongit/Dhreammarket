    ...
    <div className="relative w-full" ref={dropdownRef}>
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full h-10 pl-10 pr-10 rounded-md border border-gray-300 bg-white text-sm text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 disabled:bg-gray-100 disabled:cursor-not-allowed"
