...
export type AuditAction = 
  | 'VENDOR_APPROVED' | 'VENDOR_REJECTED' | 'USER_SUSPENDED' | 'USER_REACTIVATED' | 'ORDER_CANCELLED' | 'ORDER_REFUNDED' | 'PRODUCT_REMOVED' | 'SUPPORT_TICKET_UPDATED' | 'KYC_APPROVED' | 'KYC_REJECTED'
