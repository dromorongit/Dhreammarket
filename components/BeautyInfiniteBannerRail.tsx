...
const BEAUTY_BANNERS = [
  { id: 1, src: '/images/beauty1.jpg', alt: 'Beauty Banner 1', href: '/marketplace?category=Beauty%20and%20Personal%20Care' },
  { id: 2, src: '/images/beauty2.jpg', alt: 'Beauty Banner 2', href: '/marketplace?category=Beauty%20and%20Personal%20Care' },
  { id: 3, src: '/images/beauty3.jpg', alt: 'Beauty Banner 3', href: '/marketplace?category=Beauty%20and%20Personal%20Care' },
  { id: 4, src: '/images/beauty4.jpg', alt: 'Beauty Banner 4', href: '/marketplace?category=Beauty%20and%20Personal%20Care' },
  { id: 5, src: '/images/beauty5.jpg', alt: 'Beauty Banner 5', href: '/marketplace?category=Beauty%20and%20Personal%20Care' },
]

export default function BeautyInfiniteBannerRail() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setActiveIndex((prev) => {
        const next = (prev + 1) % BEAUTY_BANNERS.length
        scrollToIndex(next)
        return next
      })
    }, 2000)
  ...
  return (
    <section className="relative py-2 bg-slate-50" aria-label="Beauty promotional banners">
