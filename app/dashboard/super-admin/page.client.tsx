...
<svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <Button asChild variant="ghost" className="flex flex-col items-center gap-2 p-4 hover:bg-slate-50 group w-full">
                   <Link href="/dashboard/super-admin/marketing-officers">
                     <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                       <svg className="w-5 h-5 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                         <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
                       </svg>
                     </div>
                     <span className="text-sm font-medium text-slate-700">Marketing Officers</span>
                   </Link>
                 </Button>
                 <Button asChild variant="ghost" className="flex flex-col items-center gap-2 p-4 hover:bg-slate-50 group w-full">
          ...
          <CardContent className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3">
              ...
              <Link href="/dashboard/super-admin/product-categories" className="group">
               ...
               <Link href="/dashboard/super-admin/advertising" className="group">
                 <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 hover:bg-amber-50 hover:border-amber-200 border border-transparent transition-all">
                   <div className="w-8 h-8 rounded-lg bg-gradient-to-br from-amber-500 to-orange-600 flex items-center justify-center group-hover:scale-110 transition-transform">
                     <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                   ...
                   <span className="text-sm font-medium text-slate-700 group-hover:text-amber-700 transition-colors">Advertising</span>
                 </div>
               </Link>
               <Link href="/dashboard/admin/advertisements" className="group">
                 <div className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 hover:bg-teal-50 hover:border-teal-200 border border-transparent transition-all">
                   ...
                   <span className="text-sm font-medium text-slate-700 group-hover:text-teal-700 transition-colors">Banner Ads</span>
                 </div>
               </Link>
               {/* Services Section */}
