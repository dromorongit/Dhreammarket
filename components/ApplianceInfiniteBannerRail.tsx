...
const APPLIANCE_BANNERS = [
  { id: 1, src: '/images/top1.jpg', alt: 'Appliance Banner 1', href: '/marketplace?category=Appliances' },
  { id: 2, src: '/images/top2.jpg', alt: 'Appliance Banner 2', href: '/marketplace?category=Appliances' },
  { id: 3, src: '/images/top3.jpg', alt: 'Appliance Banner 3', href: '/marketplace?category=Appliances' },
]

export default function ApplianceInfiniteBannerRail() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      ...
      setActiveIndex((prev) => {
        const next = (prev + 1) % APPLIANCE_BANNERS.length
        scrollToIndex(next)
        return next
      })
    }, 2000)
  ...
  return (
    <section className="relative py-2 bg-slate-50" aria-label="Appliance promotional banners">
      <div className="w-full relative">
        ...
        >
          {APPLIANCE_BANNERS.map((banner, i) => (
            <div
              key={banner.id}
