...
const SNEAKER_BANNERS = [
  { id: 1, src: '/images/shoe1.jpg', alt: 'Sneaker Banner 1', href: '/marketplace?category=Mens%20Sneakers' },
  { id: 2, src: '/images/shoe2.jpg', alt: 'Sneaker Banner 2', href: '/marketplace?category=Mens%20Sneakers' },
  { id: 3, src: '/images/shoe3.jpg', alt: 'Sneaker Banner 3', href: '/marketplace?category=Mens%20Sneakers' },
  { id: 4, src: '/images/shoe4.jpg', alt: 'Sneaker Banner 4', href: '/marketplace?category=Mens%20Sneakers' },
  { id: 5, src: '/images/shoe5.jpg', alt: 'Sneaker Banner 5', href: '/marketplace?category=Mens%20Sneakers' },
  { id: 6, src: '/images/shoe6.jpg', alt: 'Sneaker Banner 6', href: '/marketplace?category=Mens%20Sneakers' },
]

export default function SneakerInfiniteBannerRail() {
  ...
  return (
    <section className="relative py-2 bg-slate-50" aria-label="Sneaker promotional banners">
